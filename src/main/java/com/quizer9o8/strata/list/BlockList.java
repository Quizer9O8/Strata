...
/*
        //Debug Blocks
        public static final RegistryObject<Block> DEBUG_BLOCK = BLOCKS.register("debug_block", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).destroyTime(1.5f).explosionResistance(6.0f).harvestLevel(0)));
...
*/
        ...
        //Aa
        public static final RegistryObject<Block> AA = BLOCKS.register("aa", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Cobblestone
        public static final RegistryObject<Block> AA_COBBLESTONE = BLOCKS.register("aa_cobblestone", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Mossy Cobblestone
        public static final RegistryObject<Block> MOSSY_AA_COBBLESTONE = BLOCKS.register("mossy_aa_cobblestone", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Buttons
        public static final RegistryObject<Block> AA_BUTTON = BLOCKS.register("aa_button", () -> new StrataButtonBlock(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).noCollission().destroyTime(0.5f).explosionResistance(0.5f), BlockSetType.STONE, 20, false));

        //Pressure Plates
        public static final RegistryObject<Block> AA_PRESSURE_PLATE = BLOCKS.register("aa_pressure_plate", () -> new StrataPressurePlateBlock(PressurePlateBlock.Sensitivity.MOBS, BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().noCollission().destroyTime(0.5f).explosionResistance(0.5f), BlockSetType.STONE));

        //Bricks
        public static final RegistryObject<Block> AA_BRICKS = BLOCKS.register("aa_bricks", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Polished
        public static final RegistryObject<Block> POLISHED_AA = BLOCKS.register("polished_aa", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Adakite
        public static final RegistryObject<Block> ADAKITE = BLOCKS.register("adakite", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Cobblestone
        public static final RegistryObject<Block> ADAKITE_COBBLESTONE = BLOCKS.register("adakite_cobblestone", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Mossy Cobblestone
        public static final RegistryObject<Block> MOSSY_ADAKITE_COBBLESTONE = BLOCKS.register("mossy_adakite_cobblestone", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Buttons
        public static final RegistryObject<Block> ADAKITE_BUTTON = BLOCKS.register("adakite_button", () -> new StrataButtonBlock(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).noCollission().destroyTime(0.5f).explosionResistance(0.5f), BlockSetType.STONE, 20, false));

        //Pressure Plates
        public static final RegistryObject<Block> ADAKITE_PRESSURE_PLATE = BLOCKS.register("adakite_pressure_plate", () -> new StrataPressurePlateBlock(PressurePlateBlock.Sensitivity.MOBS, BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().noCollission().destroyTime(0.5f).explosionResistance(0.5f), BlockSetType.STONE));

        //Bricks
        public static final RegistryObject<Block> ADAKITE_BRICKS = BLOCKS.register("adakite_bricks", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Polished
        public static final RegistryObject<Block> POLISHED_ADAKITE = BLOCKS.register("polished_adakite", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Basalt
        //public static final RegistryObject<Block> BASALT = BLOCKS.register("basalt", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Cobblestone
        //public static final RegistryObject<Block> BASALT_COBBLESTONE = BLOCKS.register("basalt_cobblestone", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Mossy Cobblestone
        //public static final RegistryObject<Block> MOSSY_BASALT_COBBLESTONE = BLOCKS.register("mossy_basalt_cobblestone", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Buttons
        //public static final RegistryObject<Block> BASALT_BUTTON = BLOCKS.register("basalt_button", () -> new StrataButtonBlock(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).noCollission().destroyTime(0.5f).explosionResistance(0.5f), BlockSetType.STONE));
        
        //Pressure Plates
        //public static final RegistryObject<Block> BASALT_PRESSURE_PLATE = BLOCKS.register("basalt_pressure_plate", () -> new StrataPressurePlateBlock(PressurePlateBlock.Sensitivity.MOBS, BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().noCollission().destroyTime(0.5f).explosionResistance(0.5f), BlockSetType.STONE));
        
        //Bricks
        //public static final RegistryObject<Block> BASALT_BRICKS = BLOCKS.register("basalt_bricks", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Polished
        //public static final RegistryObject<Block> POLISHED_BASALT = BLOCKS.register("polished_basalt", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Dacite
        public static final RegistryObject<Block> DACITE = BLOCKS.register("dacite", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Cobblestone
        public static final RegistryObject<Block> DACITE_COBBLESTONE = BLOCKS.register("dacite_cobblestone", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Mossy Cobblestone
        public static final RegistryObject<Block> MOSSY_DACITE_COBBLESTONE = BLOCKS.register("mossy_dacite_cobblestone", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Buttons
        public static final RegistryObject<Block> DACITE_BUTTON = BLOCKS.register("dacite_button", () -> new StrataButtonBlock(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).noCollission().destroyTime(0.5f).explosionResistance(0.5f), BlockSetType.STONE, 20, false));

        //Pressure Plates
        public static final RegistryObject<Block> DACITE_PRESSURE_PLATE = BLOCKS.register("dacite_pressure_plate", () -> new StrataPressurePlateBlock(PressurePlateBlock.Sensitivity.MOBS, BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().noCollission().destroyTime(0.5f).explosionResistance(0.5f), BlockSetType.STONE));

        //Bricks
        public static final RegistryObject<Block> DACITE_BRICKS = BLOCKS.register("dacite_bricks", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Polished
        public static final RegistryObject<Block> POLISHED_DACITE = BLOCKS.register("polished_dacite", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Dunite
        public static final RegistryObject<Block> DUNITE = BLOCKS.register("dunite", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Cobblestone
        public static final RegistryObject<Block> DUNITE_COBBLESTONE = BLOCKS.register("dunite_cobblestone", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Mossy Cobblestone
        public static final RegistryObject<Block> MOSSY_DUNITE_COBBLESTONE = BLOCKS.register("mossy_dunite_cobblestone", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Buttons
        public static final RegistryObject<Block> DUNITE_BUTTON = BLOCKS.register("dunite_button", () -> new StrataButtonBlock(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).noCollission().destroyTime(0.5f).explosionResistance(0.5f), BlockSetType.STONE, 20, false));

        //Pressure Plates
        public static final RegistryObject<Block> DUNITE_PRESSURE_PLATE = BLOCKS.register("dunite_pressure_plate", () -> new StrataPressurePlateBlock(PressurePlateBlock.Sensitivity.MOBS, BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().noCollission().destroyTime(0.5f).explosionResistance(0.5f), BlockSetType.STONE));

        //Bricks
        public static final RegistryObject<Block> DUNITE_BRICKS = BLOCKS.register("dunite_bricks", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Polished
        public static final RegistryObject<Block> POLISHED_DUNITE = BLOCKS.register("polished_dunite", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Gabbro
        public static final RegistryObject<Block> GABBRO = BLOCKS.register("gabbro", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Cobblestone
        public static final RegistryObject<Block> GABBRO_COBBLESTONE = BLOCKS.register("gabbro_cobblestone", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Mossy Cobblestone
        public static final RegistryObject<Block> MOSSY_GABBRO_COBBLESTONE = BLOCKS.register("mossy_gabbro_cobblestone", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Buttons
        public static final RegistryObject<Block> GABBRO_BUTTON = BLOCKS.register("gabbro_button", () -> new StrataButtonBlock(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).noCollission().destroyTime(0.5f).explosionResistance(0.5f), BlockSetType.STONE, 20, false));

        //Pressure Plates
        public static final RegistryObject<Block> GABBRO_PRESSURE_PLATE = BLOCKS.register("gabbro_pressure_plate", () -> new StrataPressurePlateBlock(PressurePlateBlock.Sensitivity.MOBS, BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().noCollission().destroyTime(0.5f).explosionResistance(0.5f), BlockSetType.STONE));

        //Bricks
        public static final RegistryObject<Block> GABBRO_BRICKS = BLOCKS.register("gabbro_bricks", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Polished
        public static final RegistryObject<Block> POLISHED_GABBRO = BLOCKS.register("polished_gabbro", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Komatiite
        public static final RegistryObject<Block> KOMATIITE = BLOCKS.register("komatiite", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Cobblestone
        public static final RegistryObject<Block> KOMATIITE_COBBLESTONE = BLOCKS.register("komatiite_cobblestone", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Mossy Cobblestone
        public static final RegistryObject<Block> MOSSY_KOMATIITE_COBBLESTONE = BLOCKS.register("mossy_komatiite_cobblestone", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Buttons
        public static final RegistryObject<Block> KOMATIITE_BUTTON = BLOCKS.register("komatiite_button", () -> new StrataButtonBlock(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).noCollission().destroyTime(0.5f).explosionResistance(0.5f), BlockSetType.STONE, 20, false));

        //Pressure Plates
        public static final RegistryObject<Block> KOMATIITE_PRESSURE_PLATE = BLOCKS.register("komatiite_pressure_plate", () -> new StrataPressurePlateBlock(PressurePlateBlock.Sensitivity.MOBS, BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().noCollission().destroyTime(0.5f).explosionResistance(0.5f), BlockSetType.STONE));

        //Bricks
        public static final RegistryObject<Block> KOMATIITE_BRICKS = BLOCKS.register("komatiite_bricks", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Polished
        public static final RegistryObject<Block> POLISHED_KOMATIITE = BLOCKS.register("polished_komatiite", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Pahoehoe
        public static final RegistryObject<Block> PAHOEHOE = BLOCKS.register("pahoehoe", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Cobblestone
        public static final RegistryObject<Block> PAHOEHOE_COBBLESTONE = BLOCKS.register("pahoehoe_cobblestone", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Mossy Cobblestone
        public static final RegistryObject<Block> MOSSY_PAHOEHOE_COBBLESTONE = BLOCKS.register("mossy_pahoehoe_cobblestone", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Buttons
        public static final RegistryObject<Block> PAHOEHOE_BUTTON = BLOCKS.register("pahoehoe_button", () -> new StrataButtonBlock(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).noCollission().destroyTime(0.5f).explosionResistance(0.5f), BlockSetType.STONE, 20, false));

        //Pressure Plates
        public static final RegistryObject<Block> PAHOEHOE_PRESSURE_PLATE = BLOCKS.register("pahoehoe_pressure_plate", () -> new StrataPressurePlateBlock(PressurePlateBlock.Sensitivity.MOBS, BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().noCollission().destroyTime(0.5f).explosionResistance(0.5f), BlockSetType.STONE));

        //Bricks
        public static final RegistryObject<Block> PAHOEHOE_BRICKS = BLOCKS.register("pahoehoe_bricks", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Polished
        public static final RegistryObject<Block> POLISHED_PAHOEHOE = BLOCKS.register("polished_pahoehoe", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Pegmatiite
        public static final RegistryObject<Block> PEGMATITE = BLOCKS.register("pegmatite", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Cobblestone
        public static final RegistryObject<Block> PEGMATITE_COBBLESTONE = BLOCKS.register("pegmatite_cobblestone", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Mossy Cobblestone
        public static final RegistryObject<Block> MOSSY_PEGMATITE_COBBLESTONE = BLOCKS.register("mossy_pegmatite_cobblestone", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Buttons
        public static final RegistryObject<Block> PEGMATITE_BUTTON = BLOCKS.register("pegmatite_button", () -> new StrataButtonBlock(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).noCollission().destroyTime(0.5f).explosionResistance(0.5f), BlockSetType.STONE, 20, false));

        //Pressure Plates
        public static final RegistryObject<Block> PEGMATITE_PRESSURE_PLATE = BLOCKS.register("pegmatite_pressure_plate", () -> new StrataPressurePlateBlock(PressurePlateBlock.Sensitivity.MOBS, BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().noCollission().destroyTime(0.5f).explosionResistance(0.5f), BlockSetType.STONE));

        //Bricks
        public static final RegistryObject<Block> PEGMATITE_BRICKS = BLOCKS.register("pegmatite_bricks", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Polished
        public static final RegistryObject<Block> POLISHED_PEGMATITE = BLOCKS.register("polished_pegmatite", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Phonolite
        public static final RegistryObject<Block> PHONOLITE = BLOCKS.register("phonolite", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Cobblestone
        public static final RegistryObject<Block> PHONOLITE_COBBLESTONE = BLOCKS.register("phonolite_cobblestone", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Mossy Cobblestone
        public static final RegistryObject<Block> MOSSY_PHONOLITE_COBBLESTONE = BLOCKS.register("mossy_phonolite_cobblestone", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Buttons
        public static final RegistryObject<Block> PHONOLITE_BUTTON = BLOCKS.register("phonolite_button", () -> new StrataButtonBlock(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).noCollission().destroyTime(0.5f).explosionResistance(0.5f), BlockSetType.STONE, 20, false));

        //Pressure Plates
        public static final RegistryObject<Block> PHONOLITE_PRESSURE_PLATE = BLOCKS.register("phonolite_pressure_plate", () -> new StrataPressurePlateBlock(PressurePlateBlock.Sensitivity.MOBS, BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().noCollission().destroyTime(0.5f).explosionResistance(0.5f), BlockSetType.STONE));

        //Bricks
        public static final RegistryObject<Block> PHONOLITE_BRICKS = BLOCKS.register("phonolite_bricks", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Polished
        public static final RegistryObject<Block> POLISHED_PHONOLITE = BLOCKS.register("polished_phonolite", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Amphibolite
        public static final RegistryObject<Block> AMPHIBOLITE = BLOCKS.register("amphibolite", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Cobblestone
        public static final RegistryObject<Block> AMPHIBOLITE_COBBLESTONE = BLOCKS.register("amphibolite_cobblestone", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Mossy Cobblestone
        public static final RegistryObject<Block> MOSSY_AMPHIBOLITE_COBBLESTONE = BLOCKS.register("mossy_amphibolite_cobblestone", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Buttons
        public static final RegistryObject<Block> AMPHIBOLITE_BUTTON = BLOCKS.register("amphibolite_button", () -> new StrataButtonBlock(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).noCollission().destroyTime(0.5f).explosionResistance(0.5f), BlockSetType.STONE, 20, false));

        //Pressure Plates
        public static final RegistryObject<Block> AMPHIBOLITE_PRESSURE_PLATE = BLOCKS.register("amphibolite_pressure_plate", () -> new StrataPressurePlateBlock(PressurePlateBlock.Sensitivity.MOBS, BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().noCollission().destroyTime(0.5f).explosionResistance(0.5f), BlockSetType.STONE));

        //Bricks
        public static final RegistryObject<Block> AMPHIBOLITE_BRICKS = BLOCKS.register("amphibolite_bricks", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Polished
        public static final RegistryObject<Block> POLISHED_AMPHIBOLITE = BLOCKS.register("polished_amphibolite", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Cataclasite
        public static final RegistryObject<Block> CATACLASITE = BLOCKS.register("cataclasite", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Cobblestone
        public static final RegistryObject<Block> CATACLASITE_COBBLESTONE = BLOCKS.register("cataclasite_cobblestone", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Mossy Cobblestone
        public static final RegistryObject<Block> MOSSY_CATACLASITE_COBBLESTONE = BLOCKS.register("mossy_cataclasite_cobblestone", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Buttons
        public static final RegistryObject<Block> CATACLASITE_BUTTON = BLOCKS.register("cataclasite_button", () -> new StrataButtonBlock(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).noCollission().destroyTime(0.5f).explosionResistance(0.5f), BlockSetType.STONE, 20, false));

        //Pressure Plates
        public static final RegistryObject<Block> CATACLASITE_PRESSURE_PLATE = BLOCKS.register("cataclasite_pressure_plate", () -> new StrataPressurePlateBlock(PressurePlateBlock.Sensitivity.MOBS, BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().noCollission().destroyTime(0.5f).explosionResistance(0.5f), BlockSetType.STONE));

        //Bricks
        public static final RegistryObject<Block> CATACLASITE_BRICKS = BLOCKS.register("cataclasite_bricks", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Polished
        public static final RegistryObject<Block> POLISHED_CATACLASITE = BLOCKS.register("polished_cataclasite", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Eclogite
        public static final RegistryObject<Block> ECLOGITE = BLOCKS.register("eclogite", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Cobblestone
        public static final RegistryObject<Block> ECLOGITE_COBBLESTONE = BLOCKS.register("eclogite_cobblestone", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Mossy Cobblestone
        public static final RegistryObject<Block> MOSSY_ECLOGITE_COBBLESTONE = BLOCKS.register("mossy_eclogite_cobblestone", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Buttons
        public static final RegistryObject<Block> ECLOGITE_BUTTON = BLOCKS.register("eclogite_button", () -> new StrataButtonBlock(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).noCollission().destroyTime(0.5f).explosionResistance(0.5f), BlockSetType.STONE, 20, false));

        //Pressure Plates
        public static final RegistryObject<Block> ECLOGITE_PRESSURE_PLATE = BLOCKS.register("eclogite_pressure_plate", () -> new StrataPressurePlateBlock(PressurePlateBlock.Sensitivity.MOBS, BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().noCollission().destroyTime(0.5f).explosionResistance(0.5f), BlockSetType.STONE));

        //Bricks
        public static final RegistryObject<Block> ECLOGITE_BRICKS = BLOCKS.register("eclogite_bricks", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Polished
        public static final RegistryObject<Block> POLISHED_ECLOGITE = BLOCKS.register("polished_eclogite", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Gneiss
        public static final RegistryObject<Block> GNEISS = BLOCKS.register("gneiss", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Cobblestone
        public static final RegistryObject<Block> GNEISS_COBBLESTONE = BLOCKS.register("gneiss_cobblestone", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Mossy Cobblestone
        public static final RegistryObject<Block> MOSSY_GNEISS_COBBLESTONE = BLOCKS.register("mossy_gneiss_cobblestone", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Buttons
        public static final RegistryObject<Block> GNEISS_BUTTON = BLOCKS.register("gneiss_button", () -> new StrataButtonBlock(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).noCollission().destroyTime(0.5f).explosionResistance(0.5f), BlockSetType.STONE, 20, false));

        //Pressure Plates
        public static final RegistryObject<Block> GNEISS_PRESSURE_PLATE = BLOCKS.register("gneiss_pressure_plate", () -> new StrataPressurePlateBlock(PressurePlateBlock.Sensitivity.MOBS, BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().noCollission().destroyTime(0.5f).explosionResistance(0.5f), BlockSetType.STONE));

        //Bricks
        public static final RegistryObject<Block> GNEISS_BRICKS = BLOCKS.register("gneiss_bricks", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Polished
        public static final RegistryObject<Block> POLISHED_GNEISS = BLOCKS.register("polished_gneiss", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Marble
        public static final RegistryObject<Block> MARBLE = BLOCKS.register("marble", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Cobblestone
        public static final RegistryObject<Block> MARBLE_COBBLESTONE = BLOCKS.register("marble_cobblestone", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Mossy Cobblestone
        public static final RegistryObject<Block> MOSSY_MARBLE_COBBLESTONE = BLOCKS.register("mossy_marble_cobblestone", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Buttons
        public static final RegistryObject<Block> MARBLE_BUTTON = BLOCKS.register("marble_button", () -> new StrataButtonBlock(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).noCollission().destroyTime(0.5f).explosionResistance(0.5f), BlockSetType.STONE, 20, false));

        //Pressure Plates
        public static final RegistryObject<Block> MARBLE_PRESSURE_PLATE = BLOCKS.register("marble_pressure_plate", () -> new StrataPressurePlateBlock(PressurePlateBlock.Sensitivity.MOBS, BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().noCollission().destroyTime(0.5f).explosionResistance(0.5f), BlockSetType.STONE));

        //Bricks
        public static final RegistryObject<Block> MARBLE_BRICKS = BLOCKS.register("marble_bricks", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Polished
        public static final RegistryObject<Block> POLISHED_MARBLE = BLOCKS.register("polished_marble", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Migmatite
        public static final RegistryObject<Block> MIGMATITE = BLOCKS.register("migmatite", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Cobblestone
        public static final RegistryObject<Block> MIGMATITE_COBBLESTONE = BLOCKS.register("migmatite_cobblestone", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Mossy Cobblestone
        public static final RegistryObject<Block> MOSSY_MIGMATITE_COBBLESTONE = BLOCKS.register("mossy_migmatite_cobblestone", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Buttons
        public static final RegistryObject<Block> MIGMATITE_BUTTON = BLOCKS.register("migmatite_button", () -> new StrataButtonBlock(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).noCollission().destroyTime(0.5f).explosionResistance(0.5f), BlockSetType.STONE, 20, false));

        //Pressure Plates
        public static final RegistryObject<Block> MIGMATITE_PRESSURE_PLATE = BLOCKS.register("migmatite_pressure_plate", () -> new StrataPressurePlateBlock(PressurePlateBlock.Sensitivity.MOBS, BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().noCollission().destroyTime(0.5f).explosionResistance(0.5f), BlockSetType.STONE));

        //Bricks
        public static final RegistryObject<Block> MIGMATITE_BRICKS = BLOCKS.register("migmatite_bricks", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Polished
        public static final RegistryObject<Block> POLISHED_MIGMATITE = BLOCKS.register("polished_migmatite", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Schist
        public static final RegistryObject<Block> SCHIST = BLOCKS.register("schist", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Cobblestone
        public static final RegistryObject<Block> SCHIST_COBBLESTONE = BLOCKS.register("schist_cobblestone", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Mossy Cobblestone
        public static final RegistryObject<Block> MOSSY_SCHIST_COBBLESTONE = BLOCKS.register("mossy_schist_cobblestone", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Buttons
        public static final RegistryObject<Block> SCHIST_BUTTON = BLOCKS.register("schist_button", () -> new StrataButtonBlock(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).noCollission().destroyTime(0.5f).explosionResistance(0.5f), BlockSetType.STONE, 20, false));

        //Pressure Plates
        public static final RegistryObject<Block> SCHIST_PRESSURE_PLATE = BLOCKS.register("schist_pressure_plate", () -> new StrataPressurePlateBlock(PressurePlateBlock.Sensitivity.MOBS, BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().noCollission().destroyTime(0.5f).explosionResistance(0.5f), BlockSetType.STONE));

        //Bricks
        public static final RegistryObject<Block> SCHIST_BRICKS = BLOCKS.register("schist_bricks", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Polished
        public static final RegistryObject<Block> POLISHED_SCHIST = BLOCKS.register("polished_schist", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Slate
        public static final RegistryObject<Block> SLATE = BLOCKS.register("slate", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Cobblestone
        public static final RegistryObject<Block> SLATE_COBBLESTONE = BLOCKS.register("slate_cobblestone", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Mossy Cobblestone
        public static final RegistryObject<Block> MOSSY_SLATE_COBBLESTONE = BLOCKS.register("mossy_slate_cobblestone", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Buttons
        public static final RegistryObject<Block> SLATE_BUTTON = BLOCKS.register("slate_button", () -> new StrataButtonBlock(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).noCollission().destroyTime(0.5f).explosionResistance(0.5f), BlockSetType.STONE, 20, false));

        //Pressure Plates
        public static final RegistryObject<Block> SLATE_PRESSURE_PLATE = BLOCKS.register("slate_pressure_plate", () -> new StrataPressurePlateBlock(PressurePlateBlock.Sensitivity.MOBS, BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().noCollission().destroyTime(0.5f).explosionResistance(0.5f), BlockSetType.STONE));

        //Bricks
        public static final RegistryObject<Block> SLATE_BRICKS = BLOCKS.register("slate_bricks", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Polished
        public static final RegistryObject<Block> POLISHED_SLATE = BLOCKS.register("polished_slate", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Soapstone
        public static final RegistryObject<Block> SOAPSTONE = BLOCKS.register("soapstone", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Cobblestone
        public static final RegistryObject<Block> SOAPSTONE_COBBLESTONE = BLOCKS.register("soapstone_cobblestone", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Mossy Cobblestone
        public static final RegistryObject<Block> MOSSY_SOAPSTONE_COBBLESTONE = BLOCKS.register("mossy_soapstone_cobblestone", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Buttons
        public static final RegistryObject<Block> SOAPSTONE_BUTTON = BLOCKS.register("soapstone_button", () -> new StrataButtonBlock(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).noCollission().destroyTime(0.5f).explosionResistance(0.5f), BlockSetType.STONE, 20, false));

        //Pressure Plates
        public static final RegistryObject<Block> SOAPSTONE_PRESSURE_PLATE = BLOCKS.register("soapstone_pressure_plate", () -> new StrataPressurePlateBlock(PressurePlateBlock.Sensitivity.MOBS, BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().noCollission().destroyTime(0.5f).explosionResistance(0.5f), BlockSetType.STONE));

        //Bricks
        public static final RegistryObject<Block> SOAPSTONE_BRICKS = BLOCKS.register("soapstone_bricks", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Polished
        public static final RegistryObject<Block> POLISHED_SOAPSTONE = BLOCKS.register("polished_soapstone", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Phyllite
        public static final RegistryObject<Block> PHYLLITE = BLOCKS.register("phyllite", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Cobblestone
        public static final RegistryObject<Block> PHYLLITE_COBBLESTONE = BLOCKS.register("phyllite_cobblestone", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Mossy Cobblestone
        public static final RegistryObject<Block> MOSSY_PHYLLITE_COBBLESTONE = BLOCKS.register("mossy_phyllite_cobblestone", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Buttons
        public static final RegistryObject<Block> PHYLLITE_BUTTON = BLOCKS.register("phyllite_button", () -> new StrataButtonBlock(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).noCollission().destroyTime(0.5f).explosionResistance(0.5f), BlockSetType.STONE, 20, false));

        //Pressure Plates
        public static final RegistryObject<Block> PHYLLITE_PRESSURE_PLATE = BLOCKS.register("phyllite_pressure_plate", () -> new StrataPressurePlateBlock(PressurePlateBlock.Sensitivity.MOBS, BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().noCollission().destroyTime(0.5f).explosionResistance(0.5f), BlockSetType.STONE));

        //Bricks
        public static final RegistryObject<Block> PHYLLITE_BRICKS = BLOCKS.register("phyllite_bricks", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Polished
        public static final RegistryObject<Block> POLISHED_PHYLLITE = BLOCKS.register("polished_phyllite", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Argillite
        public static final RegistryObject<Block> ARGILLITE = BLOCKS.register("argillite", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Cobblestone
        public static final RegistryObject<Block> ARGILLITE_COBBLESTONE = BLOCKS.register("argillite_cobblestone", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Mossy Cobblestone
        public static final RegistryObject<Block> MOSSY_ARGILLITE_COBBLESTONE = BLOCKS.register("mossy_argillite_cobblestone", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Buttons
        public static final RegistryObject<Block> ARGILLITE_BUTTON = BLOCKS.register("argillite_button", () -> new StrataButtonBlock(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).noCollission().destroyTime(0.5f).explosionResistance(0.5f), BlockSetType.STONE, 20, false));

        //Pressure Plates
        public static final RegistryObject<Block> ARGILLITE_PRESSURE_PLATE = BLOCKS.register("argillite_pressure_plate", () -> new StrataPressurePlateBlock(PressurePlateBlock.Sensitivity.MOBS, BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().noCollission().destroyTime(0.5f).explosionResistance(0.5f), BlockSetType.STONE));

        //Bricks
        public static final RegistryObject<Block> ARGILLITE_BRICKS = BLOCKS.register("argillite_bricks", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Polished
        public static final RegistryObject<Block> POLISHED_ARGILLITE = BLOCKS.register("polished_argillite", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Arkose
        public static final RegistryObject<Block> ARKOSE = BLOCKS.register("arkose", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Cobblestone
        public static final RegistryObject<Block> ARKOSE_COBBLESTONE = BLOCKS.register("arkose_cobblestone", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Mossy Cobblestone
        public static final RegistryObject<Block> MOSSY_ARKOSE_COBBLESTONE = BLOCKS.register("mossy_arkose_cobblestone", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Buttons
        public static final RegistryObject<Block> ARKOSE_BUTTON = BLOCKS.register("arkose_button", () -> new StrataButtonBlock(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).noCollission().destroyTime(0.5f).explosionResistance(0.5f), BlockSetType.STONE, 20, false));

        //Pressure Plates
        public static final RegistryObject<Block> ARKOSE_PRESSURE_PLATE = BLOCKS.register("arkose_pressure_plate", () -> new StrataPressurePlateBlock(PressurePlateBlock.Sensitivity.MOBS, BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().noCollission().destroyTime(0.5f).explosionResistance(0.5f), BlockSetType.STONE));

        //Bricks
        public static final RegistryObject<Block> ARKOSE_BRICKS = BLOCKS.register("arkose_bricks", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Polished
        public static final RegistryObject<Block> POLISHED_ARKOSE = BLOCKS.register("polished_arkose", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Breccia
        public static final RegistryObject<Block> BRECCIA = BLOCKS.register("breccia", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Cobblestone
        public static final RegistryObject<Block> BRECCIA_COBBLESTONE = BLOCKS.register("breccia_cobblestone", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Mossy Cobblestone
        public static final RegistryObject<Block> MOSSY_BRECCIA_COBBLESTONE = BLOCKS.register("mossy_breccia_cobblestone", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Buttons
        public static final RegistryObject<Block> BRECCIA_BUTTON = BLOCKS.register("breccia_button", () -> new StrataButtonBlock(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).noCollission().destroyTime(0.5f).explosionResistance(0.5f), BlockSetType.STONE, 20, false));

        //Pressure Plates
        public static final RegistryObject<Block> BRECCIA_PRESSURE_PLATE = BLOCKS.register("breccia_pressure_plate", () -> new StrataPressurePlateBlock(PressurePlateBlock.Sensitivity.MOBS, BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().noCollission().destroyTime(0.5f).explosionResistance(0.5f), BlockSetType.STONE));

        //Bricks
        public static final RegistryObject<Block> BRECCIA_BRICKS = BLOCKS.register("breccia_bricks", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Polished
        public static final RegistryObject<Block> POLISHED_BRECCIA = BLOCKS.register("polished_breccia", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Chalk
        public static final RegistryObject<Block> CHALK = BLOCKS.register("chalk", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(0.4f).explosionResistance(0.4f)));
        ...
        //Cobblestone
        public static final RegistryObject<Block> CHALK_COBBLESTONE = BLOCKS.register("chalk_cobblestone", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(0.4f).explosionResistance(0.4f)));
        ...
        //Mossy Cobblestone
        public static final RegistryObject<Block> MOSSY_CHALK_COBBLESTONE = BLOCKS.register("mossy_chalk_cobblestone", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.4f).explosionResistance(1.4f)));
        ...
        //Buttons
        public static final RegistryObject<Block> CHALK_BUTTON = BLOCKS.register("chalk_button", () -> new StrataButtonBlock(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).noCollission().destroyTime(0.5f).explosionResistance(0.5f), BlockSetType.STONE, 20, false));

        //Pressure Plates
        public static final RegistryObject<Block> CHALK_PRESSURE_PLATE = BLOCKS.register("chalk_pressure_plate", () -> new StrataPressurePlateBlock(PressurePlateBlock.Sensitivity.MOBS, BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().noCollission().destroyTime(0.5f).explosionResistance(0.5f), BlockSetType.STONE));

        //Bricks
        public static final RegistryObject<Block> CHALK_BRICKS = BLOCKS.register("chalk_bricks", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.4f).explosionResistance(1.4f)));
        ...
        //Polished
        public static final RegistryObject<Block> POLISHED_CHALK = BLOCKS.register("polished_chalk", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.4f).explosionResistance(1.4f)));
        ...
        //Claystone
        public static final RegistryObject<Block> CLAYSTONE = BLOCKS.register("claystone", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Cobblestone
        public static final RegistryObject<Block> CLAYSTONE_COBBLESTONE = BLOCKS.register("claystone_cobblestone", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Mossy Cobblestone
        public static final RegistryObject<Block> MOSSY_CLAYSTONE_COBBLESTONE = BLOCKS.register("mossy_claystone_cobblestone", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Buttons
        public static final RegistryObject<Block> CLAYSTONE_BUTTON = BLOCKS.register("claystone_button", () -> new StrataButtonBlock(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).noCollission().destroyTime(0.5f).explosionResistance(0.5f), BlockSetType.STONE, 20, false));

        //Pressure Plates
        public static final RegistryObject<Block> CLAYSTONE_PRESSURE_PLATE = BLOCKS.register("claystone_pressure_plate", () -> new StrataPressurePlateBlock(PressurePlateBlock.Sensitivity.MOBS, BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().noCollission().destroyTime(0.5f).explosionResistance(0.5f), BlockSetType.STONE));

        //Bricks
        public static final RegistryObject<Block> CLAYSTONE_BRICKS = BLOCKS.register("claystone_bricks", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Polished
        public static final RegistryObject<Block> POLISHED_CLAYSTONE = BLOCKS.register("polished_claystone", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Dolomite
        public static final RegistryObject<Block> DOLOMITE = BLOCKS.register("dolomite", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Cobblestone
        public static final RegistryObject<Block> DOLOMITE_COBBLESTONE = BLOCKS.register("dolomite_cobblestone", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Mossy Cobblestone
        public static final RegistryObject<Block> MOSSY_DOLOMITE_COBBLESTONE = BLOCKS.register("mossy_dolomite_cobblestone", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Buttons
        public static final RegistryObject<Block> DOLOMITE_BUTTON = BLOCKS.register("dolomite_button", () -> new StrataButtonBlock(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).noCollission().destroyTime(0.5f).explosionResistance(0.5f), BlockSetType.STONE, 20, false));

        //Pressure Plates
        public static final RegistryObject<Block> DOLOMITE_PRESSURE_PLATE = BLOCKS.register("dolomite_pressure_plate", () -> new StrataPressurePlateBlock(PressurePlateBlock.Sensitivity.MOBS, BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().noCollission().destroyTime(0.5f).explosionResistance(0.5f), BlockSetType.STONE));

        //Bricks
        public static final RegistryObject<Block> DOLOMITE_BRICKS = BLOCKS.register("dolomite_bricks", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Polished
        public static final RegistryObject<Block> POLISHED_DOLOMITE = BLOCKS.register("polished_dolomite", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Jaspillite
        public static final RegistryObject<Block> JASPILLITE = BLOCKS.register("jaspillite", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Cobblestone
        public static final RegistryObject<Block> JASPILLITE_COBBLESTONE = BLOCKS.register("jaspillite_cobblestone", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Mossy Cobblestone
        public static final RegistryObject<Block> MOSSY_JASPILLITE_COBBLESTONE = BLOCKS.register("mossy_jaspillite_cobblestone", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Buttons
        public static final RegistryObject<Block> JASPILLITE_BUTTON = BLOCKS.register("jaspillite_button", () -> new StrataButtonBlock(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).noCollission().destroyTime(0.5f).explosionResistance(0.5f), BlockSetType.STONE, 20, false));

        //Pressure Plates
        public static final RegistryObject<Block> JASPILLITE_PRESSURE_PLATE = BLOCKS.register("jaspillite_pressure_plate", () -> new StrataPressurePlateBlock(PressurePlateBlock.Sensitivity.MOBS, BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().noCollission().destroyTime(0.5f).explosionResistance(0.5f), BlockSetType.STONE));

        //Bricks
        public static final RegistryObject<Block> JASPILLITE_BRICKS = BLOCKS.register("jaspillite_bricks", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Polished
        public static final RegistryObject<Block> POLISHED_JASPILLITE = BLOCKS.register("polished_jaspillite", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Limestone
        public static final RegistryObject<Block> LIMESTONE = BLOCKS.register("limestone", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Cobblestone
        public static final RegistryObject<Block> LIMESTONE_COBBLESTONE = BLOCKS.register("limestone_cobblestone", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Mossy Cobblestone
        public static final RegistryObject<Block> MOSSY_LIMESTONE_COBBLESTONE = BLOCKS.register("mossy_limestone_cobblestone", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Buttons
        public static final RegistryObject<Block> LIMESTONE_BUTTON = BLOCKS.register("limestone_button", () -> new StrataButtonBlock(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).noCollission().destroyTime(0.5f).explosionResistance(0.5f), BlockSetType.STONE, 20, false));

        //Pressure Plates
        public static final RegistryObject<Block> LIMESTONE_PRESSURE_PLATE = BLOCKS.register("limestone_pressure_plate", () -> new StrataPressurePlateBlock(PressurePlateBlock.Sensitivity.MOBS, BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().noCollission().destroyTime(0.5f).explosionResistance(0.5f), BlockSetType.STONE));

        //Bricks
        public static final RegistryObject<Block> LIMESTONE_BRICKS = BLOCKS.register("limestone_bricks", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Polished
        public static final RegistryObject<Block> POLISHED_LIMESTONE = BLOCKS.register("polished_limestone", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Mudstone
        public static final RegistryObject<Block> MUDSTONE = BLOCKS.register("mudstone", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Cobblestone
        public static final RegistryObject<Block> MUDSTONE_COBBLESTONE = BLOCKS.register("mudstone_cobblestone", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Mossy Cobblestone
        public static final RegistryObject<Block> MOSSY_MUDSTONE_COBBLESTONE = BLOCKS.register("mossy_mudstone_cobblestone", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Buttons
        public static final RegistryObject<Block> MUDSTONE_BUTTON = BLOCKS.register("mudstone_button", () -> new StrataButtonBlock(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).noCollission().destroyTime(0.5f).explosionResistance(0.5f), BlockSetType.STONE, 20, false));

        //Pressure Plates
        public static final RegistryObject<Block> MUDSTONE_PRESSURE_PLATE = BLOCKS.register("mudstone_pressure_plate", () -> new StrataPressurePlateBlock(PressurePlateBlock.Sensitivity.MOBS, BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().noCollission().destroyTime(0.5f).explosionResistance(0.5f), BlockSetType.STONE));

        //Bricks
        public static final RegistryObject<Block> MUDSTONE_BRICKS = BLOCKS.register("mudstone_bricks", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Polished
        public static final RegistryObject<Block> POLISHED_MUDSTONE = BLOCKS.register("polished_mudstone", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Shale
        public static final RegistryObject<Block> SHALE = BLOCKS.register("shale", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Cobblestone
        public static final RegistryObject<Block> SHALE_COBBLESTONE = BLOCKS.register("shale_cobblestone", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Mossy Cobblestone
        public static final RegistryObject<Block> MOSSY_SHALE_COBBLESTONE = BLOCKS.register("mossy_shale_cobblestone", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Buttons
        public static final RegistryObject<Block> SHALE_BUTTON = BLOCKS.register("shale_button", () -> new StrataButtonBlock(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).noCollission().destroyTime(0.5f).explosionResistance(0.5f), BlockSetType.STONE, 20, false));

        //Pressure Plates
        public static final RegistryObject<Block> SHALE_PRESSURE_PLATE = BLOCKS.register("shale_pressure_plate", () -> new StrataPressurePlateBlock(PressurePlateBlock.Sensitivity.MOBS, BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().noCollission().destroyTime(0.5f).explosionResistance(0.5f), BlockSetType.STONE));

        //Bricks
        public static final RegistryObject<Block> SHALE_BRICKS = BLOCKS.register("shale_bricks", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
        ...
        //Polished
        public static final RegistryObject<Block> POLISHED_SHALE = BLOCKS.register("polished_shale", () -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.STONE).requiresCorrectToolForDrops().destroyTime(1.5f).explosionResistance(6.0f)));
